...
| Rapporto mensile sui costi | Riepilogo mensile dei costi per il tuo account, con indicazione delle tendenze di spesa, delle variazioni anomale e delle migliori opportunità di risparmio per FSx for ONTAP file systems. | Rapporto sui costi | Consiglio | Deposito generale | FSx per file system ONTAP 


| Ritardo di replica | La replicazione sta richiedendo più tempo del previsto. | Replicazione | Critico | Deposito generale | FSx per file system ONTAP 


| Creazione dashboard personalizzato riuscita | La tua dashboard personalizzata è stata creata correttamente ed è pronta per essere visualizzata. | Cruscotti personalizzati | Successo | Deposito generale | Account Workload Factory 


| Creazione dashboard personalizzata non riuscita | Workload Factory non è riuscita a creare la tua dashboard personalizzata. Prova a creare di nuovo la dashboard. | Cruscotti personalizzati | Errore | Deposito generale | Account Workload Factory 
|===
...
--
[[wf-console-email-notifications]]
...
[[filter-notifications-in-netapp-console]]
