...
| Convalidare le autorizzazioni disponibili nel ruolo e confrontarle con le autorizzazioni richieste | iam:SimulatePrincipalPolicy | Implementazione | Automatizzare 
|===
...
.3+| Controllare il collegamento SSM al motore ai | ssm:SendCommand | Implementazione | Automatizzare 


| ssm:GetConnectionStatus | Implementazione | Automatizzare 


| ssm:SendCommand | Implementazione | Automatizzare 
...
| Verifica dell'accesso al modello di base | Bedrock:GetFoundationModelAvailability | Risoluzione dei problemi | Automatizzare 
|===
====
...
.4+| Ottieni i dettagli chiave del KMS e utilizza la crittografia per Amazon FSX per NetApp ONTAP | Km: CreateGrant | Implementazione | Automatizzare 
