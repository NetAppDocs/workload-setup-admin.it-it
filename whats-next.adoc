...
* https://docs.netapp.com/us-en/workload-builders/index.html["Carichi di lavoro del costruttore"^]
+
Semplifica l'utilizzo e l'accesso alle versioni del software consentendo l'integrazione immediata dei cloni con i sistemi di controllo delle versioni e i flussi CI/CD, risparmiando tempo e risorse.
