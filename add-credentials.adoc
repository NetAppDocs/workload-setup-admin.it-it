...
La fabbrica del carico di lavoro opererà in modalità _Basic_ a meno che non vengano aggiunte le credenziali dell'account AWS. È possibile aggiungere credenziali per abilitare altre modalità operative, come la modalità _sola lettura_ e la modalità _lettura/scrittura_. link:operational-modes.html["Ulteriori informazioni sulle modalità operative"].
